...
-- =====================================================================
-- 3b. CALL MESSAGES (in-call text chat)
-- =====================================================================
...
DROP POLICY IF EXISTS "Call participants can view messages" ON public.call_messages;
...
DROP POLICY IF EXISTS "Call participants can send messages" ON public.call_messages;
